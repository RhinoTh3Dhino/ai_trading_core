import sys, os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))  # ← Gør utils-import robust!
...
import subprocess
from utils.robust_utils import safe_run  # ← Import virker nu altid!
