...
def needs_project_root(content):
    ...
    search_terms = [
        'read_csv(', 'to_csv(', 'to_pickle(', 'read_pickle(',
        '"data/', "'data/", '"outputs/', "'outputs/", '"models/', "'models/",
        "os.path.join('data'", 'os.path.join("data"', 'os.path.join(\'outputs\'', 'os.path.join("outputs"',
