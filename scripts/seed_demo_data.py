...
for i in range(30):
    ...
    rows.append([d.isoformat(), signal_count, trades, win_rate, gross_pnl, net_pnl, max_dd, sharpe_d])
...
pd.DataFrame(fills, columns=[
    "ts","symbol","side","qty","price","commission","pnl_realized"
