...
def fetch_and_save(
    ...
    try:
        ...
        files = sorted(
            glob.glob(os.path.join(outdir, f"{symbol.upper()}_{interval}_*.csv")),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Antal dage tilbage at hente (kan også hedde --days)",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Antal seneste bars at bruge (valgfrit)",
    )
