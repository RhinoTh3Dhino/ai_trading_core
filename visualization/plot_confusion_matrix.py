...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path til y_true (CSV/NPY/TXT eller kolonne i DF)",
    )
    parser.add_argument(
        "--y_pred",
        type=str,
        required=True,
        help="Path til y_pred (CSV/NPY/TXT eller kolonne i DF)",
    )
    parser.add_argument(
        "--labels", type=str, default=None, help="Kommasepareret labels, fx 'SELL,BUY'"
    )
    parser.add_argument(
        "--normalize", type=str, default=None, help="'true', 'pred', 'all', eller None"
    )
