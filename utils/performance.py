...
# --------- DEN NYE GRID SEARCH FUNKTION ---------

def calculate_performance_metrics(equity_curve, trades_df):
    """
    Returnerer et dictionary med alle relevante metrics til grid search!
    """
    sharpe = calculate_sharpe_ratio(equity_curve)
    sortino = calculate_sortino_ratio(equity_curve)
    max_dd = calculate_max_drawdown(equity_curve)
    ...
    # Robust - brug iloc hvis det er en Pandas Series, ellers [-1] (liste/array)
