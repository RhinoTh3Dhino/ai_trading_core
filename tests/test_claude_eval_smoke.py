...
def test_validate_payload_rejects_invalid():
    ...
    # Udenfor interval
    bad2 = {"edge_score": 1.1, "opportunities": [], "warnings": [], "action": "hold", "confidence": 0.5}
    assert ce.validate_payload(bad2) is False

    # Forkert action
    bad3 = {"edge_score": 0.4, "opportunities": [], "warnings": [], "action": "buy", "confidence": 0.5}
    assert ce.validate_payload(bad3) is False

    # Forkert typer
    bad4 = {"edge_score": 0.4, "opportunities": "x", "warnings": [], "action": "hold", "confidence": 0.5}
